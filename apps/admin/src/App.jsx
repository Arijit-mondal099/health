                ...
                <main className="min-w-0 flex-1 px-4 md:px-8">
                    <Routes>
                        ...
                        <Route
                            ...
                            element={<ProtectedRoute token={adminToken} element={<Dashboard />} />}
                        />
                        <Route
                            path="/appointments"
                            element={
                                <ProtectedRoute token={adminToken} element={<Appointments />} />
                            }
                        />
                        <Route
                            path="/add-doctor"
                            element={<ProtectedRoute token={adminToken} element={<AddDoctor />} />}
                        />
                        <Route
                            path="/doctors-list"
                            element={
                                <ProtectedRoute token={adminToken} element={<DoctorsList />} />
                            }
                        />
                        ...
                        <Route
                            ...
                            element={
                                <ProtectedRoute token={doctorToken} element={<DoctorDashboard />} />
                            }
                        />
                        <Route
                        ...
                        <Route
                            path="/doctor-profile"
                            element={
                                <ProtectedRoute token={doctorToken} element={<DoctorProfile />} />
                            }
                        />

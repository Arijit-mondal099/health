...
export const doctorLogin = async (req, res) => {
  try {
    ...
    return res.status(200).json(new ApiResponse(200, "Doctor login successfully!", doctorToken));
  } catch (error) {
...
export const getDoctorDashboard = async (req, res) => {
  try {
    ...
    return res.status(200).json(new ApiResponse(200, "Fetched successfully", { 
      earnings, patients, complete, cancel,
...
export const updateDoctorProfile = async (req, res) => {
  try {
    ...
    const updatedDoctor = await Doctor.findByIdAndUpdate(_id, data, { new: true }).select("-password");

    return res.status(200).json(new ApiResponse(200, "Profile update successfylly", updatedDoctor));
  } catch (error) {
